...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_registrationview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='registrationview'
        )
        self.assertTrue(view.__name__ == 'registrationview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in registrationview'
        # )

    def test_registrationview_not_matching_interface(self):
